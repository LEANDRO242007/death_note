...
$url = "https://api.telegram.org/bot6032944387:AAFCq1LF-ct4BT9VhmBF7IafDET4GO_aaQs/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
